...
public abstract class BaseCompressingHandler
    implements HttpHandler, RequestHandler<Map<String, String>, String> {

  abstract byte[] process(BufferedImage bi, String targetFormat, float compressionQuality)
      throws IOException;
  ...
  public void handle(HttpExchange t) throws IOException {
    ...
    if (t.getRequestMethod().equalsIgnoreCase("OPTIONS")) {
      ...
      // Result syntax:
      // targetFormat:<targetFormat>;compressionFactor:<factor>;data:image/<currentFormat>;base64,<encoded image>
      String result =
  ...
  public String handleRequest(Map<String, String> event, Context context) {
    return handleRequest(
        event.get("body"),
        event.get("targetFormat"),
        Float.parseFloat(event.get("compressionFactor")));
  }
}
