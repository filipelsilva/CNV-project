...
java_cmd="cd /home/ec2-user && java -cp webserver-1.0.0-SNAPSHOT-jar-with-dependencies.jar -Xbootclasspath/a:webserver-1.0.0-SNAPSHOT-jar-with-dependencies.jar,JavassistWrapper-1.0-jar-with-dependencies.jar -javaagent:JavassistWrapper-1.0-jar-with-dependencies.jar=ICount:pt.ulisboa.tecnico.cnv,javax.imageio:output pt.ulisboa.tecnico.cnv.webserver.WebServer"
